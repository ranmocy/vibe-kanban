...
Configure appearance, default agent, editor, git preferences, notifications, tags, and beta features.

<Card title="General Settings" icon="gear" href="/settings-beta/general">
...
<Card title="Organisation Settings" icon="buildings" href="/settings-beta/organization-settings">
...
<Card title="Remote Projects" icon="cloud" href="/settings-beta/remote-projects">
...
- **Left column (Agents)** - Available coding agents (Claude Code, Codex, Gemini, etc.)
