...
const CreatePRDialogImpl = NiceModal.create<CreatePRDialogProps>(
  ({ attempt, task, repoId, targetBranch }) => {
    ...
    const handleGenerateContent = useCallback(async () => {
      ...
      const result = await attemptsApi.generatePrContent(attempt.id, {
        repo_id: repoId,
      });
      ...
      if (result.success) {
        ...
        setError(
          result.message || 'Failed to generate PR title and description'
        );
      }
    }, [attempt.id, repoId]);
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    disabled={generatingTitle || generatingBody || !repoId}
                  >
                    {generatingTitle || generatingBody ? (
                      <>
